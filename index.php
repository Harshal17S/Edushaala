...
<section id="footer">
    <div class="main-footer">
      <div class="logoinfo" data-aos="fade-up">
        ...
        <div class="contact-details">
          <h1>Contact Us</h1>
          <li>
            <div class="fa fa-phone"></div><a href="tel:+91 7385864121">+91 7385864121</a></li>
          <li>
            <div class="fa fa-envelope"></div><a href="mailto:edushaalahelp@gmail.com">edushaalahelp@gmail.com</a></li>
          </li>
      </div>
    </div>
    <div class="com " data-aos="fade-up">
      <h1>Contact us</h1>
      <ul>
        <li><a href="https://instagram.com/edu_shaala.help?igshid=ZDdkNTZiNTM">Insta</a></li>
        <li><a href="">LinkedIn</a></li>
        <li><a href="">Facebook</a></li>
        <li><a href="https://www.youtube.com/channel/UCN-6mKEyfEpTiyfYF7u1zww">Youtube</a></li>
      </ul>
    </div>
